...
def draw_class_distribution(labels, object_type):
    ...
    plt.savefig(f"./output/analyze_dataset/class_distribution_{object_type}.png")
    plt.show()
...
def draw_measurement_count(labels):
    ...
    df_distance_count = df_distance_count[~df_distance_count.index.duplicated()]
    ...
    plt.savefig("./output/analyze_dataset/Num_Measurements as a function of Object Distance.png")
    plt.show()
    ...
    plt.savefig("./output/analyze_dataset/Num_Measurements as a function of Object Distance, ROI Selection.png")
    plt.show()
